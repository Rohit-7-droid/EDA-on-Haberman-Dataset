# -*- coding: utf-8 -*-
"""Copy of Assignment 7 - EDA.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1KsOzKLwqd0P_VsLVy0ju-eH5I1W6QkRU
...
try:
    ...
    import requests
    r = requests.get("https://datahub.io/machine-learning/haberman/r/1.html.csv")
    with open("haberman.csv",'wb') as f: 
        f.write(r.content) 
    haberman = pd.read_csv("haberman.csv") 
...
sns.set_style("whitegrid")
sns.FacetGrid(haberman, col="status", height=4)\
.map(plt.scatter, "age", "year")\
.add_legend()
plt.show()
...
sns.FacetGrid(haberman,row="status", size=8)\
...
data[(data['status'] == 2) & (data['age']<55)].shape[0] * 100 // data[data['status'] == 2].shape[0]
